...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'bg',
            type:'image',
            rect:['448px','0px','1024px','576px','auto','auto'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: false,
         timeline: [
            { id: "eid7", tween: [ "style", "${_logo-trans2}", "top", '200px', { fromValue: '200px'}], position: 0, duration: 0 },
            { id: "eid8", tween: [ "style", "${_logo-trans2}", "top", '100px', { fromValue: '200px'}], position: 250, duration: 1000 },
            { id: "eid5", tween: [ "style", "${_logo-trans2_blur}", "top", '200px', { fromValue: '200px'}], position: 0, duration: 0 },
            { id: "eid4", tween: [ "style", "${_logo-trans2_blur}", "top", '100px', { fromValue: '200px'}], position: 250, duration: 1000 },
            { id: "eid10", tween: [ "style", "${_output}", "opacity", '0.98', { fromValue: '0.98'}], position: 1250, duration: 0 },
